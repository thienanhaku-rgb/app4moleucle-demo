...
export function Header({ mode = 'generate', setMode, onMobileMenuClick }: HeaderProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" className="md:hidden text-muted-foreground" onClick={onMobileMenuClick}>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <div className="flex items-center gap-1 bg-muted/30 p-1 rounded-full border border-border/50">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="hidden sm:inline-flex w-8 h-8 md:w-9 md:h-9 rounded-full text-muted-foreground hover:text-foreground hover:bg-background"
          >
